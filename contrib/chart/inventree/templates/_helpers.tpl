...
*/}}
{{- define "inventree.postgresql.fullname" -}}
...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "inventree.redis.fullname" -}}
{{- include "common.names.dependency.fullname" (dict "chartName" "redis" "chartValues" .Values.redis "context" $) -}}
{{- end -}}

{{/*
Return the proper inventree image name
*/}}
{{- define "inventree.image" -}}
...
*/}}
{{- define "inventree.host" -}}
{{- if .Values.ingress.enabled }}
    {{- $host := .Values.ingress.hostname | default "" -}}
    {{- default (include "inventree.serviceIP" .) $host -}}
{{- else -}}
...
{{/*
Return true if a secret object for inventree should be created
*/}}
{{- define "inventree.createSecret" -}}
...
{{/*
Return the inventree secret name
*/}}
{{- define "inventree.secretName" -}}
{{- default (printf "%s-inventree" (include "common.names.fullname" .)) (tpl .Values.auth.existingSecret $) -}}
{{- end -}}

{{/*
Return the inventree SMTP secret name
*/}}
{{- define "smtp.secretName" -}}
{{- default (printf "%s-inventree" (include "common.names.fullname" .)) (tpl .Values.smtp.existingSecret $) -}}
{{- end -}}

{{/*
Return true if inventree SMTP uses password authentication
*/}}
...
*/}}
{{- define "inventree.database.host" -}}
{{- ternary (include "inventree.postgresql.fullname" .) .Values.externalDatabase.host .Values.postgresql.enabled | quote -}}
{{- end -}}

{{/*
Return the Postgresql port
*/}}
{{- define "inventree.database.port" -}}
...
*/}}
{{- define "inventree.database.name" -}}
...
*/}}
{{- define "inventree.database.user" -}}
{{- if .Values.postgresql.enabled }}
    {{- if .Values.global.postgresql }}
        {{- if .Values.global.postgresql.auth }}
...
*/}}
{{- define "inventree.database.secretName" -}}
{{- if .Values.postgresql.enabled }}
    {{- if .Values.global.postgresql }}
        {{- if .Values.global.postgresql.auth }}
            ...
            {{- else -}}
                {{- default (include "inventree.postgresql.fullname" .) (tpl .Values.postgresql.auth.existingSecret $) -}}
            {{- end -}}
        {{- else -}}
            {{- default (include "inventree.postgresql.fullname" .) (tpl .Values.postgresql.auth.existingSecret $) -}}
        {{- end -}}
...
*/}}
{{- define "inventree.database.secretPasswordKey" -}}
{{- if .Values.postgresql.enabled -}}
    {{- print "password" -}}
{{- else -}}
...
*/}}
{{- define "inventree.database.secretPostgresPasswordKey" -}}
{{- if .Values.postgresql.enabled -}}
...
*/}}
{{- define "inventree.redis.host" -}}
{{- ternary (printf "%s-master" (include "inventree.redis.fullname" .)) .Values.externalRedis.host .Values.redis.enabled | quote -}}
{{- end -}}

{{/*
Return the Redis&reg; port
*/}}
{{- define "inventree.redis.port" -}}
...
*/}}
{{- define "inventree.redis.secretName" -}}
{{- if .Values.redis.enabled }}
    {{- if .Values.redis.auth.existingSecret }}
        {{- printf "%s" .Values.redis.auth.existingSecret -}}
    {{- else -}}
        {{- printf "%s" (include "inventree.redis.fullname" .) -}}
    {{- end -}}
...
*/}}
{{- define "inventree.redis.secretPasswordKey" -}}
{{- if .Values.redis.enabled -}}
...
*/}}
{{- define "inventree.redis.auth.enabled" -}}
